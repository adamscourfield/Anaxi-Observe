...
function EmptyIcon() {
  return (
    <svg viewBox="0 0 40 40" fill="none" className="mx-auto mb-4 h-10 w-10 text-muted/30" xmlns="http://www.w3.org/2000/svg">
...
export function EmptyState({
  ...
  return (
    <Card tone="subtle" className="border-dashed py-12 text-center">
      {content}
    </Card>
  );
}
