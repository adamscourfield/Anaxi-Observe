  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Use these when you need a specific brand colour that isn't
        // covered by a semantic alias above.
        coral:  "#fe9f9f",
        blue:   "#4b66bb",
        amber:  "#fdc683",
        ...
        "blue-5":    "rgba(75,102,187,0.05)",
        "blue-8":    "rgba(75,102,187,0.08)",
        "blue-16":   "rgba(75,102,187,0.16)",
      ...
      fontSize: {
        // Matches existing usage patterns in home/explorer pages
